...
### Structure
- `generate.py` — Creates SVG art from date seed (9 styles: spirals, waves, crystals, petals, grid, constellations, roots, aurora, veins)
...
### Changelog
- **2026-03-13**: Added aurora and veins styles. Gallery hover: scale + shadow. Grown seed 2026-03-13.
