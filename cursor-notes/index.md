...
### Structure
- `generate.py` — Creates SVG art from date seed (8 styles: spirals, waves, crystals, petals, grid, constellations, roots, lichen)
...
### Changelog
- **2026-03-15**: Added lichen generative style (irregular organic patches + tendrils). Added hover scale animation on seed cards.
