...
### Structure
- `generate.py` — Creates SVG art from date seed (10 styles: spirals, waves, crystals, petals, grid, constellations, roots, aurora, lichen, moire)
...
### Changelog
- **2026-03-16**: Added 3 new styles (aurora, lichen, moire). Gallery hover zoom on seed images. Backfilled 2026-03-13 through 2026-03-15.
